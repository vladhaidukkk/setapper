...
function NavMenuItem({ path, icon: Icon, children }) {
  ...
  return (
    <li>
      <Link
        to={path}
        className={`flex items-center rounded-md border px-2.5 py-1 text-sm font-medium
                outline-none transition-colors duration-200 hover:border-stone-300 hover:bg-stone-200 hover:text-black focus:border-stone-300 focus:bg-stone-200 focus:text-black
