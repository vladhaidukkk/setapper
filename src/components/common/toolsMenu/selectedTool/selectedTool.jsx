  ...
  return (
    <button
      ...
      className="flex h-full w-full items-center justify-between rounded-md border border-stone-300
          bg-white pl-2.5 font-medium text-stone-700 shadow-sm outline-none
          focus-within:border-indigo-600 focus-within:text-black focus-within:ring-1 focus-within:ring-indigo-600
          hover:text-black dark:border-stone-700 dark:bg-stone-800 dark:text-stone-300
          dark:focus-within:border-indigo-500 dark:focus-within:text-white dark:focus-within:ring-indigo-500
